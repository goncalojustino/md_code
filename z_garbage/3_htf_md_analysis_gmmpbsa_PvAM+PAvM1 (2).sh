...
for f in protein_md{043..049}_A    # CORRECT FOLDERS
 do
 ...
 g_mmpbsa -f md_fitted.xtc -s md.tpr -n index_mmpbsa.ndx -pdie 2 -decomp -mm PAvM_energy_mm.xvg -mmcon PAvM_contrib_mm.dat -dt 20 < maker
 #2 calculation of polar solvation energy
 g_mmpbsa -f md_fitted.xtc -s md.tpr -n index_mmpbsa.ndx -i /work_opt/g_mmpbsa/mdp_samples/mmpbsa_polar.mdp -nomme -pbsa -decomp -pol PAvM_polar.xvg -pcon PAvM_contrib_pol.dat -dt 20 < maker
 #3 calculation of non-polar solvation energy --> WCA only model
 g_mmpbsa -f md_fitted.xtc -s md.tpr -n index_mmpbsa.ndx -i /work_opt/g_mmpbsa/mdp_samples/mmpbsa_wca_ap.mdp -nomme -pbsa -decomp -apol PAvM_wca.xvg -apcon  PAvM_contrib_wca.dat -dt 20 < maker
