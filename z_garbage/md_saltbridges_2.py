...
acid = universe.select_atoms("(resname ASP and name OD*) or (resname GLU and name OE*) or (resname TYO and name OH) or (resname HIT and name ND*) or (resname HIT and name NE*) or (resname HISH and name NE*) or (resname HISH and name ND*)")
basic = universe.select_atoms("(resname ARG and name NH*) or (resname LYS* and name NZ*)")
