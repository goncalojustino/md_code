...
/workopt/anaconda3/bin/ipython3  "-c %run /workcode/analysis/analysis_md_saltbridges_KatieBC.py"
/workopt/anaconda3/bin/ipython3  "-c %run /workcode/analysis/analysis_md_pipi_CareBC.py.py"
