  ...
  while j < len(piSystems):
    ...
    if str(piCoords2) != str(numpy.zeros(3)):
      ...
      if orientation == "undefined":
        print(piSystems[i].resname,piSystems[i].resid," - ",piSystems[j].resname,piSystems[j].resid," pi-pi: not present")
      else:
        print(piSystems[i].resname,piSystems[i].resid," - ",piSystems[j].resname,piSystems[j].resid," pi-pi: ",orientation,", centroid distance =",dist,", dihedral = ",dihedral)
